...
double prevyaw=0;
double q0_prev=0,q1_prev=0,q2_prev=0,q3_prev=0;
...
*/
    ...
    //q0=q0*0.3+q0_prev*0.7,q1=q1*0.3+q1_prev*0.7,q2=q2*0.3+q2_prev*0.7;q3=q3*0.3+q3_prev*0.7;
    
    //q0_prev=q0,q1_prev=q1,q2_prev=q2,q3_prev=q3;
